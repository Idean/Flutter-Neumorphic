...
class NeumorphicForegroundDecoration extends Decoration {
  ...
  NeumorphicForegroundDecoration lerpFrom(Decoration a, double t) {
    ...
    if (a is NeumorphicForegroundDecoration)
      return NeumorphicForegroundDecoration.lerp(a, this, t);
  ...
  NeumorphicForegroundDecoration lerpTo(Decoration b, double t) {
    ...
    if (b is NeumorphicForegroundDecoration)
      return NeumorphicForegroundDecoration.lerp(this, b, t);
  ...
  static NeumorphicForegroundDecoration lerp(NeumorphicForegroundDecoration a,
      NeumorphicForegroundDecoration b, double t) {
    assert(t != null);
    ...
    return NeumorphicForegroundDecoration(
        ...
        style: a.style.copyWith(
          ...
          shadowLightColor:
              Color.lerp(aStyle.shadowLightColor, bStyle.shadowLightColor, t),
          shadowDarkColor:
              Color.lerp(aStyle.shadowDarkColor, bStyle.shadowDarkColor, t),
          shadowLightColorEmboss: Color.lerp(
              aStyle.shadowLightColorEmboss, bStyle.shadowLightColorEmboss, t),
          shadowDarkColorEmboss: Color.lerp(
              aStyle.shadowDarkColorEmboss, bStyle.shadowDarkColorEmboss, t),
          lightSource:
